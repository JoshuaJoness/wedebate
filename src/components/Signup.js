...
const options = [
  {
    value: "checkboxOne",
    label:
      "By checking this box you hereby grant 'We Debate' to use your image in any way that they see fit within the context of the site. You also certify that I have full legal rights to this image.",
    disabled: false
  },
  {
    value: "checkboxTwo",
    label:
      "By checking this box I certify that I am of legal age in my jurisdiction to use this site.",
    disabled: false
  }
];
...
class Signup extends React.Component {
  ...
  submit = e => {
    ...
    if (
      ...
      user.username &&
      user.password &&
      this.state.values.includes("checkboxOne" && "checkboxTwo")
    ) {
      axios
      ...
      alert("Please complete all fields, and check all boxes.");
    }
  };
          ...
          <div>
            <form className="formSignup" onSubmit={this.submit}>
              ...
              <div className="rainbow-p-vertical_large rainbow-p-horizontal_xx-large rainbow-m-horizontal_xx-large">
                ...
                <div
                  className="rainbow-p-vertical_large rainbow-p-left_xx-large"
                  className="upload"
                >
                  <br></br>
